...
def create_exchange_dicts(ftx_intl_crypto_df: pd.DataFrame, ftx_international_related_party_df: pd.DataFrame,
                          ftx_us_crypto_df: pd.DataFrame, ftx_us_related_party_df: pd.DataFrame) -> (dict, dict):
    ftx_dotcom_exchange = {
        "assets": {
            ...
            "Receivables": ftx_international_related_party_df["Estimated Receivables"].sum(),
        },
        "liabilities": {
            ...
            "Related Party Payables": ftx_international_related_party_df["Estimated Payables"].sum(),
        }
    }
...
def create_exchange_graphs(ftx_intl_crypto_df, ftx_international_related_party_df, ftx_us_crypto_df,
                       ftx_us_related_party_df):
    ftx_dotcom_exchange, ftx_us_exchange = create_exchange_dicts(ftx_intl_crypto_df, ftx_international_related_party_df,
    ...
    for i, exchange in enumerate(exchanges):
        ...
        exchange_graphs.append(html.Div(exchange_graph, className="three columns", style={'margin': '80px'}))
